 ...
 */
@Embeddable
public class Orden_laboratorioPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof Orden_laboratorioPK)) {
			return false;
		}
		Orden_laboratorioPK castOther = (Orden_laboratorioPK)other;
		return 
