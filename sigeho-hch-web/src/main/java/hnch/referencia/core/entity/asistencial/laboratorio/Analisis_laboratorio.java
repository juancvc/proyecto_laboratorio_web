...
@NamedStoredProcedureQueries({
		@NamedStoredProcedureQuery(name = "postulante.insertar", procedureName = "[SIGEHOV2BANC].[GENE].[ADMISION_POSTULANTE_INSERT]", resultClasses = Analisis_laboratorio.class, parameters = {
...
@NamedStoredProcedureQuery(name = "postulante.modificar", procedureName = "[SIGEHOV2BANC].BANC.CAMPANIA_UPDATE", resultClasses = Analisis_laboratorio.class, parameters = {
...
@NamedStoredProcedureQuery(name = "postulante.eliminar", procedureName = "[SIGEHOV2BANC].[BANC].[POSTULANTE_DELETE]", resultClasses = Analisis_laboratorio.class, parameters = {
...
@NamedStoredProcedureQuery(name = "postulante.buscarPorFiltros", procedureName = "[SIGEHOV2BANC].[BANC].[POSTULANTE_CAMPANIA_LISTA_X_FILTRO]", resultClasses = Analisis_laboratorio.class, parameters = {
		
			@StoredProcedureParameter(mode = ParameterMode.IN, name = "CODCAMPA", type = String.class) 
 }),
@NamedStoredProcedureQuery(name = "postulante.buscarPorObjeto", procedureName = "[SIGEHOV2BANC].[BANC].[POSTULANTE_CAMPANIA_LISTA_X_OBJETO]", resultClasses = Analisis_laboratorio.class, parameters = {
...
@NamedStoredProcedureQuery(name = "postulante.buscarUltimaDonacion", procedureName = "[SIGEHOV2BANC].[GENE].[ADMISION_FECHA_ULTIMA_DONACION]", resultClasses = Analisis_laboratorio.class, parameters = {
		
			@StoredProcedureParameter(mode = ParameterMode.IN, name = "CODPERSO", type = String.class) 
 }),

@NamedStoredProcedureQuery(name = "postulante.estadoFisicoBuscarPorFiltros", procedureName = "[SIGEHOV2BANC].[BANC].[POSTULANTE_ESTADOFISICO_CAMPANIA_LISTA_X_FILTRO]", resultClasses = Analisis_laboratorio.class, parameters = {
...
@NamedStoredProcedureQuery(name = "postulante.estadoFisicoBuscarPorObjeto", procedureName = "[SIGEHOV2BANC]. [BANC].[POSTULANTE_ESTADOFISICO_CAMPANIA_LISTA_X_OBJETO]", resultClasses = Analisis_laboratorio.class, parameters = {
...
@NamedStoredProcedureQuery(name = "postulante.preDonantesBuscarPorFiltros", procedureName = "[SIGEHOV2BANC].BANC.[PREDONANTES_ENTREVISTA_LISTA_X_FILTRO]", resultClasses = Analisis_laboratorio.class, parameters = {
		
		@StoredProcedureParameter(mode = ParameterMode.IN, name = "FECHA", type = String.class)  
}),
	
@NamedStoredProcedureQuery(name = "postulante.litarEstadoFisicaPorPerso", procedureName = "[SIGEHOV2BANC].[GENE].[ADMISION_ULTIMA_EVALUACION_FISICA_V_WEB]", resultClasses = Analisis_laboratorio.class, parameters = {
...
@Entity
public class Analisis_laboratorio implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	 private Analisis_laboratorioPK id;
	...
	public Analisis_laboratorioPK getId() {
		return id;
	}
 
	public void setId(Analisis_laboratorioPK id) {
		this.id = id;
	} 
