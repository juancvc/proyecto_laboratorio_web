 ...
 */
@Embeddable
public class Paciente_laboratorioPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof Paciente_laboratorioPK)) {
			return false;
		}
		Paciente_laboratorioPK castOther = (Paciente_laboratorioPK)other;
		return 
