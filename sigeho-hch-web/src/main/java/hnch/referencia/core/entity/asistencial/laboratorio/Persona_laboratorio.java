...
@NamedStoredProcedureQueries(
		...
		@NamedStoredProcedureQuery(name = "persona.insertar", procedureName = "[RECO].[PERSONA_INSERT]", resultClasses = Persona_laboratorio.class, parameters = {
		...
		@NamedStoredProcedureQuery(name = "persona.insertarPersonaBanco", procedureName = "SIGEHOV2GENE.[GENE].[USP_PERSONA_INSERT_BANCO_WEB]", resultClasses = Persona_laboratorio.class, parameters = {
		...
		@NamedStoredProcedureQuery(name = "persona.actualizarPersonaBanco", procedureName = "SIGEHOV2GENE.[GENE].[USP_PERSONA_UPDATE_BANCO_WEB]", resultClasses = Persona_laboratorio.class, parameters = {
		...
		@NamedStoredProcedureQuery(
							...
							resultClasses= Persona_laboratorio.class,
							parameters={ 
										@StoredProcedureParameter(mode=ParameterMode.IN,name="TG1TPDOC", type=String.class ),
										@StoredProcedureParameter(mode=ParameterMode.IN,name="NRODOCUM", type=String.class )
								}					
...
public class Persona_laboratorio implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private Persona_laboratorioPK id;
...
//	@Column(name = "FOTODETA")
	...
	public Persona_laboratorioPK getId() {
		return this.id;
	}

	public void setId(Persona_laboratorioPK id) {
		this.id = id;
	}
