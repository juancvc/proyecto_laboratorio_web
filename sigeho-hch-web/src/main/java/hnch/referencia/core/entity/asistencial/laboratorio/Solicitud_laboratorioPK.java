 ...
 */
@Embeddable
public class Solicitud_laboratorioPK implements Serializable {
	...
	public Solicitud_laboratorioPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof Solicitud_laboratorioPK)) {
			return false;
		}
		Solicitud_laboratorioPK castOther = (Solicitud_laboratorioPK)other;
		return 
