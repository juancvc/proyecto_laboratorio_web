...
@NamedStoredProcedureQueries({
		@NamedStoredProcedureQuery(name = "postulante.insertar", procedureName = "[SIGEHOV2BANC].[GENE].[ADMISION_POSTULANTE_INSERT]", resultClasses = Orden_laboratorio.class, parameters = {
