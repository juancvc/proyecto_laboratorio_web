...
@NamedStoredProcedureQueries(
		{
			...
			@NamedStoredProcedureQuery(name = "paciente.insertar",
					...
					resultClasses = Paciente_laboratorio.class, parameters = {
			...
			@NamedStoredProcedureQuery(
						...
						resultClasses= Paciente_laboratorio.class,
						parameters={ 
									@StoredProcedureParameter(mode=ParameterMode.IN,name="CODPERSO", type=String.class ),
									@StoredProcedureParameter(mode=ParameterMode.IN,name="NROPERPE", type=String.class )
							}					
...
public class Paciente_laboratorio implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private Paciente_laboratorioPK id;
	...
	public Paciente_laboratorio() {
	}

	public Paciente_laboratorioPK getId() {
		return this.id;
	}

	public void setId(Paciente_laboratorioPK id) {
		this.id = id;
	}
