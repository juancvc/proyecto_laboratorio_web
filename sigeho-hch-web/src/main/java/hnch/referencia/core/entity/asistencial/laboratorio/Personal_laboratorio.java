...
public class Personal_laboratorio implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private Personal_laboratorioPK id;
	...
	public Personal_laboratorio() {
	}

	public Personal_laboratorioPK getId() {
		return this.id;
	}

	public void setId(Personal_laboratorioPK id) {
		this.id = id;
	}
