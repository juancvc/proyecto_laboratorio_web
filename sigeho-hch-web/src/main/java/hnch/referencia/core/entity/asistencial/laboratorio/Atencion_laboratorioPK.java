 ...
 */
@Embeddable
public class Atencion_laboratorioPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof Atencion_laboratorioPK)) {
			return false;
		}
		Atencion_laboratorioPK castOther = (Atencion_laboratorioPK)other;
		return 
