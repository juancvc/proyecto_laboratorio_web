 ...
 */
@Embeddable
public class Analisis_laboratorioPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof Analisis_laboratorioPK)) {
			return false;
		}
		Analisis_laboratorioPK castOther = (Analisis_laboratorioPK)other;
		return 
